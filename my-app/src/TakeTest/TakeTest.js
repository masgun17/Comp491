...
import PartInformation from "../pages/PartInformation"; // needs to change
import QuestionBody from "../pages/QuestionBody"; // needs to change
import styles from "../TakeTest/TakeTest.css"
