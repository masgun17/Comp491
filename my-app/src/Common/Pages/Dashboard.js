...
import { saveImageAction, getImagesAction, updateImageAction, deleteImageAction, removeAllImagesAction, saveVideoAction, getVideosAction } from "../../tool/actions"
    ...
    <div className="wrapper">
      ...
      <div className="dashboardLayout" style={{ "font-size": fontSize }}>
        <div className="dashboardDiv2" style={{ "grid-row-start": "2" }}>
          ...
          <div>Demans, beyindeki bir kısım hücrelerin çalışması durduğunda ya da işlev görmediğinde görülen semptomlar topluluğunu tanımlamak için kullanılan bir terimdir. Günlük aktivitelerin gerçekleştirilmesinde gerekli olan beceriler ile hafıza, davranış, düşünme süreçlerinin bozulduğu bir sendromdur. Günlük yaşamı ve fonksiyonları aksatacak kadar bilişsel fonksiyonların ilerleyici olarak kaybedilmesi ile karakterizedir. Demans, beyini birincil veya ikincil olarak etkileyen birçok hastalığın (Alzheimer, inme vb.) sonucu olarak ortaya çıkar (Rahman & Howard, 2018; Rahman, Howard, Harrison Dening, & Swaffer, 2018; W.H.O., 2020). </div>
          <br></br>
          <ul style={{ "font-size": fontSize }}>
            <li>
              Demans, yaşlanmanın normal bir parçası değildir.
            </li>
            <li>
              'Demans' ve 'Alzheimer hastalığı' terimleri aynı anlama gelmez. Demans, beyni etkileyen 100'den fazla farklı hastalıkla ilişkili bir sendromu tanımlayan şemsiye bir terimdir.            </li>
            <li>
              Demans genellikle zihinsel veya bilişsel işlev kaybıyla ilişkilidir.            </li>
            <li>
              65 yaşından küçük yetişkinlerde de demans görülebilir.             </li>
            <li>
              Yaşam stilimizle ilgili risk faktörlerinde azalma ve koruyucu faktörlerde artış demans geliştirme şansını azaltabilir.             </li>
          </ul>
        </div>
      </div>
      <ImageUploading
